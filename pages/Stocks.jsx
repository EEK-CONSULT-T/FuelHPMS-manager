...
const Stocks = () => {
  ...
  const [keroseneTotal,setKeroseneTotal] = useState(0);
     ...
     try {
       ...
       const unsubscribe = onSnapshot(queryRef, (querySnapshot) => {
         ...
         querySnapshot.forEach((doc) => {
           ...
           // Assuming fuel_type is a field in the stock object
           if (stock.fuel_type === "diesel") {
             dieselTotal += stock.amount || 0;
           } else if (stock.fuel_type === "super") {
             superTotal += stock.amount || 0;
           } else if (stock.fuel_type === "kerosene") {
             keroseneTotal += stock.amount || 0;
           }
         });
         ...
         setKeroseneTotal(keroseneTotal);
