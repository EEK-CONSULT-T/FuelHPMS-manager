                    ...
                    <>
                      <li>
                        <input
                          ...
                          id="groupLeader"
                          className="mr-2"
                          checked={subroles.groupLeader}
                          onChange={handleSubroleChange}
                        />
                        <label for="role">Group Leader</label>
                      </li>
                    </>
                  ) : (
                    <>
